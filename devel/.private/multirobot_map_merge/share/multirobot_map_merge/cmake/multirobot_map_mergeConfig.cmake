...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/conlab/ssv2_ws/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/conlab/ssv2_ws/devel/.private/multirobot_map_merge)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/conlab/ssv2_ws/install)
...
if(NOT "/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/conlab/ssv2_ws/src/m-explore/map_merge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(multirobot_map_merge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libopencv_calib3d.so.3.4.20;/usr/local/lib/libopencv_core.so.3.4.20;/usr/local/lib/libopencv_dnn.so.3.4.20;/usr/local/lib/libopencv_features2d.so.3.4.20;/usr/local/lib/libopencv_flann.so.3.4.20;/usr/local/lib/libopencv_highgui.so.3.4.20;/usr/local/lib/libopencv_imgcodecs.so.3.4.20;/usr/local/lib/libopencv_imgproc.so.3.4.20;/usr/local/lib/libopencv_ml.so.3.4.20;/usr/local/lib/libopencv_objdetect.so.3.4.20;/usr/local/lib/libopencv_photo.so.3.4.20;/usr/local/lib/libopencv_shape.so.3.4.20;/usr/local/lib/libopencv_stitching.so.3.4.20;/usr/local/lib/libopencv_superres.so.3.4.20;/usr/local/lib/libopencv_video.so.3.4.20;/usr/local/lib/libopencv_videoio.so.3.4.20;/usr/local/lib/libopencv_videostab.so.3.4.20;/usr/local/lib/libopencv_viz.so.3.4.20")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/conlab/ssv2_ws/devel/.private/multirobot_map_merge/lib;/home/conlab/ssv2_ws/devel/lib;/home/conlab/ss_ws/devel/lib;/home/conlab/slam_ws/devel/lib;/home/conlab/jackal_catkin_ws/devel/lib;/home/conlab/crazyswarm_conlab/crazyswarm/ros_ws/devel/lib;/opt/ros/noetic/lib)
